...
<div className="music-auctions">
    ...
    <div className="products-section1">
      ...
      <div className="section1">
        ...
        <div className="section1-prod-image">
          <img className="prod-images" src="/images/iamworthy.svg" width={260} height={217}/>
        </div>
      ...
      <div className="section1">
        ...
        <div className="section1-prod-image">
          <img className="prod-images" src="/images/hotsugar.svg" width={260} height={217}/>
        </div>
        <div className="prod-end-section">
          <div className="section1-prod-name">
            <p>HOT SUGAR</p>
      ...
      <div className="section1">
        ...
        <div className="section1-prod-image">
          <img className="prod-images" src="/images/multiverge.svg" width={260} height={217}/>
        </div>
        <div className="prod-end-section">
          <div className="section1-prod-name">
            <p>Multiverge</p>
      ...
      <div className="section1">
        ...
        <div className="section1-prod-image">
          <img className="prod-images" src="/images/radioactive.svg" width={260} height={217}/>
        </div>
        <div className="prod-end-section">
          <div className="section1-prod-name">
            <p>Radioactive</p>
    ...
    <div className="products-section1">
      ...
      <div className="section1">
        ...
        <div className="section1-prod-image">
          <img className="prod-images" src="/images/technoastronaught.svg" width={260} height={217}/>
        </div>
        
        <div className="prod-end-section">
          <div className="section1-prod-name">
            <p>Techno Astronaught</p>
          </div>
      ...
      <div className="section1">
        ...
        <div className="section1-prod-image">
          <img className="prod-images" src="/images/internetofhumans.svg" width={260} height={217}/>
        </div>
        <div className="prod-end-section">
          <div className="section1-prod-name">
            <p>Internet of Humans</p>
          </div>
      ...
      <div className="section1">
        ...
        <div className="section1-prod-image">
          <img className="prod-images" src="/images/theglitch.svg" width={260} height={217}/>
        </div>
        <div className="prod-end-section">
          <div className="section1-prod-name">
            <p>THE GLITCH</p>
      ...
      <div className="section1">
        ...
        <div className="section1-prod-image">
          <img className="prod-images" src="/images/colorfulworld.svg" width={260} height={217}/>
        </div>
        <div className="prod-end-section">
          <div className="section1-prod-name">
            <p>Colorful World</p>
