...
import "./SellOnAuction.css"

export default function SellOnAuction() {
  return (
    <div>
    ...
    <div className="section1">
        ...
        <img className="prod-images" src="/images/sell_img1.svg" width={260} height={217}/>
        </div>
    ...
    <div className="section1">
        ...
        <div className="section1-prod-image">
        <img className="prod-images" src="/images/sell_img2.svg" width={260} height={217}/>
        </div>
        <div className="prod-end-section">
        <div className="section1-prod-name">
    ...
    <div className="section1">
        ...
        <div className="section1-prod-image">
        <img className="prod-images" src="/images/sell_img3.svg" width={260} height={217}/>
        </div>
        <div className="prod-end-section">
        <div className="section1-prod-name">
            <p>Man with love</p>
    ...
    <div className="section1">
        ...
        <div className="section1-prod-image">
        <img className="prod-images" src="/images/sell_img4.svg" width={260} height={217}/>
        </div>
        <div className="prod-end-section">
        <div className="section1-prod-name">
    ...
    <div className="section1">
        ...
        <div className="section1-prod-image">
        <img className="prod-images" src="/images/sell_img5.svg" width={260} height={217}/>
        </div>
    ...
    <div className="section1">
        ...
        <div className="section1-prod-image">
        <img className="prod-images" src="/images/sell_img6.svg" width={260} height={217}/>
        </div>
        <div className="prod-end-section">
        <div className="section1-prod-name">
            <p>Black Otaku</p>
    ...
    <div className='bottom-texts'>
            <div className='building-search'>
                ...
                <div className='sell-button'>
                    <button>Sell your craft on theNFTway</button>
                </div>
            </div>
    </div>
